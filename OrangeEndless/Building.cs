...
namespace OrangeEndless
{
    public class Building
    {
        ...
        public static Building LoadBuilding ( int key )
        {
            ...
            var Temp = new Building
            {
                ...
                Introduction = BuildingsIntroductionResource . ResourceManager . GetString ( "R" + id , CultureInfo . InvariantCulture ) ,
                StartCps = Convert . ToDecimal ( BuildingsStartCpsResource . ResourceManager . GetString ( "R" + id , CultureInfo . InvariantCulture ) , CultureInfo . InvariantCulture ) ,
